...
Vous devez avoir un compte GitHub et au niveau de Netlify vous pourrez deployer un modéle de site 11ty que vous pourrez adapter à vos besoins. Netlify utilisera le contenu du repository déployé pour générer des pages statiques sur ces propres serveurs.
